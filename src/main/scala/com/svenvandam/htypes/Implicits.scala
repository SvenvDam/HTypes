...
import com.svenvandam.htypes.bytes.Instances
import com.svenvandam.htypes.converters.{QuerySyntax, ResultSyntax, ScalaConverter}

object Implicits extends TableSyntax with ScalaConverter with QuerySyntax with ResultSyntax with Instances
